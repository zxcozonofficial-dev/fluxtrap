...
// =====================================================================
{
  ...
  s.addText('«Гимн великому городу»  ·  музыка Рейнгольда Глиэра  ·  слова Олега Чупрова', {
...
// =====================================================================
// SLIDE 2 — вступление, цель, задачи
// =====================================================================
{
  const s = p.addSlide();
...
// =====================================================================
{
  ...
  // timeline
  const items = [
    ["1949", "Премьера балета «Медный всадник» в Ленинграде. Его финал назвали «Гимн великому городу»"],
    ["1950-е–80-е", "Мелодия звучит отдельно от балета и становится музыкальным символом Ленинграда"],
    ["1991", "Музыка Глиэра официально утверждена гимном города, в год, когда ему вернули имя Санкт-Петербург"],
    ["2003", "К 300-летию города утверждён текст гимна, его автор Олег Чупров"],
  ];
  const lineY = 4.55;
...
// =====================================================================
{
  ...
  s.addText("Гимн не рассказывает о Петербурге словами, а как будто рисует его звуком. Вот пять приёмов, в которых это слышно:", {
  ...
  s.addText([
    ...
    { text: "Гимн родился из балета о памятнике Петру I, о теме основания города силой воли, на пустом месте.", options: { color: "EAF0F7", fontSize: 10 } },
  ], {
...
// =====================================================================
{
  ...
  s.addText([
    ...
    { text: "мелодию узнают почти все, а автора почти никто не называет. Гипотеза подтвердилась.", options: { color: TEXT } },
  ], {
...
// =====================================================================
{
  ...
  s.addText("Гимн как музыкальный портрет города", {
    x: 0.9, y: 1.3, w: 11, h: 1.3,
    fontFace: FONT_HEAD, fontSize: 32, bold: true, color: "FFFFFF",
    isTextBox: true, margin: 0,
  });
  s.addText(
"Мы начинали с простого вопроса: что мы вообще знаем о гимне своего города, кроме того, что он красивый. За мелодией нашлась целая история: музыка из балета о «Медном всаднике», написанная Глиэром в годы, когда город поднимался после блокады, полвека жизни без слов, официальный статус в 1991 году и текст Олега Чупрова, появившийся только к 300-летию.\n\nГимн стоит в одном ряду с гербом и флагом, но работает иначе. Герб можно нарисовать, флаг вывесить, а гимн человек просто чувствует, и в этот момент ощущает себя частью города.",
    {
  ...
  s.addText([
    { text: "Гимн получился таким же строгим и величественным, как сам город. ", options: { bold: true, color: "FFFFFF" } },
  ...
  s.addNotes(
"Мы начинали с простого вопроса: что мы вообще знаем о гимне своего города, кроме того, что он красивый. Оказалось, что за этой мелодией стоит целая история: музыка из балета о «Медном всаднике», написанная Глиэром в годы, когда город поднимался после блокады, полвека жизни без слов, официальный статус в 1991 году и текст Олега Чупрова, появившийся только к 300-летию города.\n\nГлавное, что мы поняли: гимн стоит в одном ряду с гербом и флагом, но работает иначе. Герб можно нарисовать, флаг вывесить, а гимн человек просто чувствует: он слышит его на вокзале, на празднике, в День Победы, и в этот момент ощущает себя частью города. Именно поэтому мелодия Глиэра пережила и смену эпохи, и смену названия города. Петербург однажды узнал в ней себя и не отпускает до сих пор.\n\nСпасибо за внимание!"
  );
  pageNum(s, 6);
}
...
// =====================================================================
{
  ...
  const src = [
    "Р. М. Глиэр (1875–1956), балет «Медный всадник» по поэме А. С. Пушкина; премьера в Ленинграде, Театр им. С. М. Кирова (ныне Мариинский), 1949 год",
    "Финальный номер балета называется «Гимн великому городу»",
    "В 1991 году музыка Глиэра утверждена гимном города",
    "В 2003 году законом Санкт-Петербурга утверждён текст гимна, его автор Олег Чупров",
